    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Å Å½Å¡Å¾Å¸Ă€ĂĂ‚ĂƒĂ„Ă…Ă‡ĂˆĂ‰ĂĂ‹ĂŒĂĂĂĂ‘Ă’Ă“Ă”Ă•Ă–Ă˜Ă™ĂĂ›ĂœĂĂ Ă¡Ă¢Ă£Ă¤Ă¥Ă§Ă¨Ă©ĂªĂ«Ă¬Ă­Ă®Ă¯Ă±Ă²Ă³Ă´ĂµĂ¶Ă¸Ă¹ĂºĂ»Ă¼Ă½Ă¿'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('Ă' => 'TH', 'Ă¾' => 'th', 'Ă' => 'DH', 'Ă°' => 'dh', 'ĂŸ' => 'ss', 'Å’' => 'OE', 'Å“' => 'oe', 'Ă†' => 'AE', 'Ă¦' => 'ae', 'Âµ' => 'u'));
